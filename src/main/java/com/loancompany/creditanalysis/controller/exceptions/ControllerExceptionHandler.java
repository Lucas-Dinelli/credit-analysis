package com.loancompany.creditanalysis.controller.exceptions;
...
public class ControllerExceptionHandler {
	...
	@ExceptionHandler(DateFirstInstallmentException.class)
	public ResponseEntity<DefaultError> dateFirstInstallmentException(DateFirstInstallmentException e, ServletRequest request) {
